...
import os
import logging
from class_200130_PageObject.Common.project_path import log_dir
from class_200130_PageObject.Common.read_config import ReadConfig
...
class MyLog:
    ...
    def create_logger(self,message,level):
        #定义一个日志收集器
        my_logger = logging.getLogger('ui_auto')
        #设定日志的级别
